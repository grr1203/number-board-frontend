    ...
    <div className="flex flex-col w-screen h-screen bg-[url(/image.png)] bg-cover bg-center overflow-hidden">
      ...
      <div className="h-1/3 relative pt-16 mb-10">
        ...
        <div className="absolute inset-0 flex justify-between mx-12 w-full">
          <div className="text-white text-8xl font-semibold mt-28 w-1/6 min-w-72">창구 1</div>
      ...
      <div className="h-1/3 relative pt-12">
        <img src="/line.png" className="w-full h-44" />
        <div className="absolute inset-0 flex justify-between mx-12 w-full">
          <div className="text-white text-8xl font-semibold mt-24 w-1/6 min-w-72">창구 2</div>
